...
export declare abstract class ZodType<Output, Def extends ZodTypeDef = ZodTypeDef, Input = Output> {
    ...
    safeParse(data: unknown, params?: Partial<ParseParams>): {
        success: true;
        data: Output;
    } | {
        success: false;
    ...
    safeParseAsync(data: unknown, params?: Partial<ParseParams>): Promise<{
        success: true;
        data: Output;
    } | {
        success: false;
    ...
    spa: (data: unknown, params?: Partial<ParseParams> | undefined) => Promise<{
        success: true;
        data: Output;
    } | {
        success: false;
    ...
    check: never;
    refine<Func extends (arg: Output) => any>(check: Func, message?: string | CustomErrorParams | ((arg: Output) => CustomErrorParams)): ZodEffects<this, Output, Input>;
    refinement(check: (arg: Output) => any, refinementData: IssueData | ((arg: Output, ctx: RefinementCtx) => IssueData)): ZodEffects<this, Output, Input>;
